...
<head>
    ...
    <title>Editar Contenido - CID Pujllay</title>
                ...
                <form
                    ...
                    <div style="margin-bottom:20px;">
                        ...
                        <select
                            ...
                            <option
                                value="Inicio"
                                {{ old('section', $content->section) == 'Inicio' ? 'selected' : '' }}>
                            ...
                            <option
                                value="Nosotros"
                                {{ old('section', $content->section) == 'Nosotros' ? 'selected' : '' }}>
                            ...
                            <option
                                value="Galería"
                                {{ old('section', $content->section) == 'Galería' ? 'selected' : '' }}>
                            ...
                            <option
                                value="Programas"
                                {{ old('section', $content->section) == 'Programas' ? 'selected' : '' }}>
                            ...
                            <option
                                value="Visitas"
                                {{ old('section', $content->section) == 'Visitas' ? 'selected' : '' }}>
                            ...
                            <option
                                value="Silvia TV"
                                {{ old('section', $content->section) == 'Silvia TV' ? 'selected' : '' }}>
                            ...
                            <option
                                ...
                                {{ old('section', $content->section) == 'Capacitaciones' ? 'selected' : '' }}>
                            ...
                            <option
                                value="Contacto"
                                {{ old('section', $content->section) == 'Contacto' ? 'selected' : '' }}>
        ...
        function actualizarCampoContenido() {
            ...
            if (
                ...
                contentHelp.textContent =
                    'Pega aquí el enlace del nuevo video de YouTube.';
